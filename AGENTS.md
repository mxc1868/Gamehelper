...
- Current destination: `https://github.com/mxc1868/Gamehelper`, branch `main`.
- Active work is the GameHelper WhereTheWispsAt migration. Earlier ExileCore reverse-engineering research was explicitly cleared; do not restart it without a new request.
...
- Windows users have no compiler. Build on Linux with `scripts/package-wisps.py`; distribute the full self-contained x64 ZIP and its checksum through this repository's GitHub Releases.
