...
- The user explicitly chose source-only delivery after the UniqueLoot DLL was locked. Do not update Test or ask them to close GameHelper unless they request deployment again. UniqueLoot ground names now default to selected highlights only; keep the configurable opt-out.
