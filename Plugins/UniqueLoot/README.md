...
“只显示已高亮物品的名称”（`OnlyShowHighlightedItemNames`）默认开启，旧设置没有该字段时也采用开启状态。地面名称只显示勾选并启用高亮的物品；关闭此选项可恢复普通暗金名称，未知物品再由原“显示未知”选项控制。屏幕列表始终只显示高亮物品。
...
- “选择高亮物品”提供搜索、滚动清单和“仅查看已勾选物品”。同名称的不同外观一起勾选；共用贴图保留全部候选，不伪装成确定识别。默认取消勾选后，地面名称和屏幕高亮列表均隐藏该物品。
