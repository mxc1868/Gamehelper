namespace ShowMeWisp
{
    ...
    public sealed class ShowMeWispSettings : IPSettings
    {
        ...
        public bool ScaleWispBoxes = true;
        public float SmallWispScale = 0.6f;
        public float MediumWispScale = 1;
        public float BigWispScale = 1.6f;
        ...
        public void Normalize()
        {
            ...
            this.SmallWispScale = Clamp(this.SmallWispScale, 0.1f, 4, 0.6f);
            this.MediumWispScale = Clamp(this.MediumWispScale, 0.1f, 4, 1);
            this.BigWispScale = Clamp(this.BigWispScale, 0.1f, 4, 1.6f);
